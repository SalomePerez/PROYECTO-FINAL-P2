...
public class JugadorTest {
    ...
    public void registrarJugadorEquipo() {
        ...
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",LocalDate.now().minusYears(15),TipoGenero.MASCULINO);
    ...
    public void registrarJugadorTorneo() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL,null, null, TipoGeneroTorneo.FEMENINO, null, null, null);
    ...
    public void registrarJugadorTorneoSinLimiteEdad() {
        LOG.info("Inicio de prueba registrar Jugador Torneo Sin Limite Edad...");
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)0, 0,TipoTorneo.LOCAL,null, null, TipoGeneroTorneo.FEMENINO, null, null, null);

        var representante = new Persona("Robinson", "Pulgarin", "rpulgarin@email.com", "6067359300");
        var equipo = new Equipo("Uniquindio", representante);
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",LocalDate.now().minusYears(21), TipoGenero.MASCULINO);
        ...
        assertTrue(equipo.jugadores().contains(jugador));
        assertEquals(1, equipo.jugadores().size());
        LOG.info("Fin de prueba registrar Jugador Torneo Sin Limite Edad...");
    }
    ...
    public void registrarJugadorTorneoConLimiteEdad() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL, null, null, TipoGeneroTorneo.MASCULINO, null, null, null);
    ...
    public void registrarJugadorTorneoInscripcionesCerradas() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(1), (byte)24, (byte)18, 0,TipoTorneo.LOCAL,null, null, TipoGeneroTorneo.MASCULINO, null, null, null);
    ...
    public void registrarJugadoresRepetidosEquipo() {
        ...
        var equipo = new Equipo("Uniquindio", representante);
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",LocalDate.now().minusYears(15), TipoGenero.MASCULINO);
        var jugador2 = new Jugador("Christian", "Candela", "ccandela@email.com", "6067431235",LocalDate.now().minusYears(15),TipoGenero.MASCULINO);
        equipo.registrarJugador(jugador);
    ...
    public void registrarJugadoresRepetidosTorneo() {
        ...
        var torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL,null, null, TipoGeneroTorneo.MASCULINO, null, null, null);
